...
from PyQt6.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QLabel, 
                             ...
                             QDateEdit, QGroupBox, QMessageBox, QScrollArea, QWidget)
from PyQt6.QtCore import Qt, QDate
from PyQt6.QtGui import QFont

from models.db_models import User, Patient, Facility, DEPARTMENTS, GENDER_CHOICES, PATIENT_TYPE_CHOICES
...
class PatientFormDialog(QDialog):
    ...
    def _fill_data(self):
        ...
        self.gender_combo.setCurrentText("Мужской" if self.patient.gender == "M" else "Женский")
        self.type_combo.setCurrentText("Взрослый" if self.patient.patient_type == "adult" else "Детский")
    ...
    def _save(self):
        ...
        QMessageBox.information(self, "Успешно", 
            f"Пациент {self.patient.full_name} сохранён")
        self.accept()
