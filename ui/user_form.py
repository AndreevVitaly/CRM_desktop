...
class UserFormDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        self.password_input.setPlaceholderText("Придумайте пароль" if not self.is_edit else "Оставьте пустым для сохранения")
        self.password_input.setEchoMode(QLineEdit.EchoMode.Password)
        main_layout.addRow("Пароль*" if not self.is_edit else "Пароль", self.password_input)
    ...
    def _save(self):
        ...
        QMessageBox.information(self, "Успешно",
            f"Пользователь {self.user.full_name} сохранён")
        self.accept()
