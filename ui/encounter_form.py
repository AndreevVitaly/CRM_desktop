...
from PyQt6.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QLabel, 
                             QPushButton, QFormLayout, QComboBox, QTextEdit,
                             QDateTimeEdit, QMessageBox)
from PyQt6.QtCore import Qt, QDateTime
from PyQt6.QtGui import QFont

from models.db_models import User, Patient, Encounter, Note, Prescription, PatientInteraction
...
class EncounterFormDialog(QDialog):
    ...
    def _fill_data(self):
        ...
        self.started_at_input.setDateTime(QDateTime(
    ...
    def _save(self):
        ...
        if self.user.role in (User.ROLE_ADMIN, User.ROLE_LEAD, User.ROLE_DOCTOR):
            if hasattr(self, 'medication_input') and self.medication_input.text().strip():
                rx = Prescription(
                    encounter_id=self.encounter.id,
